#!/usr/bin/env python3
"""
Amber Lucid ONE Robotic Arm ROS2 Integration Example

This example demonstrates how to bridge ReGenNexus Core with a ROS 2-based
Amber Lucid ONE robotic arm. It maps the /joint_states topic into a ReGenNexus entity
...
async def async_main():
    bridge = ROSBridge(node_name='amber_lucid1_bridge')
    ...
    # Map the Amber Lucid ONE's joint_states topic into a ReGenNexus entity
    await bridge.map_topic_to_entity(
        topic_name='/joint_states',
        entity_id='amber_lucid1_arm',
        direction='to_entity',
        message_type='sensor_msgs/JointState',
        topic_to_entity_transform=jointstate_to_dict
    )
    logger.info("Mapped /joint_states -> entity 'amber_lucid1_arm'.")
    ...
    cmd = {
        ...
        'positions': [0.0, 0.3, -0.3, 0.6, -0.6, 1.0],
        'time_from_start': 4
    }
